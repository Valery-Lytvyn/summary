...
export const createContactsDataArr = () => {
   return (
      [
         {
            icon: messengersIconsArray, info: { label: '+38 050 967 89 26', type: 'telephon' }
         },
         {
            icon: <AiOutlineMail />, info: { label: 'lytvynvalery@gmail.com', type: 'mail', link: 'lytvynvb@gmail.com' }
         },
         {
            icon: <TbBrandGithub />, info: { label: 'github', type: 'link', link: 'https://github.com/Valery-Lytvyn' }
         },
         {
            icon: <SlSocialLinkedin />, info: { label: 'linkedin', type: 'link', link: 'https://linkedin.com' }
         },
         {
